...
<div class="page-content-wrap">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            ?>
            <form action="/Boarder/insert_post" class="boarder_insert_form form-horizontal" method="post" enctype="multipart/form-data">
                <input type="hidden" class="form-control post_seq" name="seq" placeholder="Placeholder text" value="<?=$data->seq?>">
                        ...
                        <div class="form-group password_form_group">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="input-group">
                                    ...
                                    <input type="password" name="boarder_post_pw" class="form-control boarder_post_pw" value="<?=$data->boarder_post_pw?>"/>
                                </div>
            ...
            <form role="form" action="/Boarder/img_upload" method="post" class="img_upload_form" enctype="multipart/form-data">
                <div class="modal-body form-horizontal form-group-separated">
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="file" class="fileinput btn-info user_file" name="user_file" id="cp_photo" data-filename-placement="inside" title="Select file"/>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form role="form" action="/Boarder/multi_img_upload" method="post" class="multi_upload_form" enctype="multipart/form-data">
                ...
                <div class="modal-body form-horizontal form-group-separated">
                    <div class="form-group">
                        <label class="col-md-4 control-label">New Photo</label>
                        <div class="col-md-4 multi_upload_inputfile_war">
