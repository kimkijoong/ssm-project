			...
			<div class="row">
				<div class="main-content xs-col-4 sm-col-11 md-col-11">
                    <div class="bookmark-header xs-col-4 sm-col-11 md-col-11">
                        ...
                        <div class="md-push-1 sm-push-1 md-col-9 sm-col-9 xs-col-4 tab-left-margin">
                                ...
                                <section class="row" id="section1" role="tabpanel" aria-labelledby="tab1">
                                    <div class="md-col-9 sm-col-9 xs-col-4 one-card-align">
                                        <article class="md-col-9 sm-col-9 xs-col-4">
                                            <a href="#" class="bk-wrting-card">
                                                <div class="bookmark-section1">
                                                    <img class="profile-img" src="/static/images/userprofile/userimage01.jpg" alt="">
                                                    <p class="username">jessica</p>
                                                </div>
                                        ...
                                        <article class="md-col-9 sm-col-9 xs-col-4">
                                            <a href="#" class="bk-wrting-card">
                                                <div class="bookmark-section1">
                                                    <img class="profile-img" src="/static/images/userprofile/userimage02.jpg" alt="">
                                                    <p class="username">jessica</p>
                                                </div>
                                                <div class="bookmark-section2">
                                                    <p class="card-content-heading">끌림에 대하여</p>
                                        ...
                                        <article class="md-col-9 sm-col-9 xs-col-4">
                                            <a href="#" class="bk-wrting-card">
                                                <div class="bookmark-section1">
                                                    <img class="profile-img" src="/static/images/userprofile/userimage05.jpg" alt="">
                                                    <p class="username">harmony</p>
                                                </div>
                                                <div class="bookmark-section2">
                                                    <p class="card-content-heading">주말엔 숲으로</p>
                                                    <p class="card-content-text">
                                                        현실 보다 더 중요한 것이 이상이라며 고집하다가 이상만큼 중요한 것이 현실이라고 인정할 수밖에 없는 날. 난 그런 날에 살면서 살아야할 이유를 찾는다. 내 삶과 내 가슴이 남김없이 불타오를 거룩한 사랑 …
                                                    </p>
                                                    <p class="card-info-date">
                                        ...
                                        <article class="md-col-9 sm-col-9 xs-col-4">
                                            <a href="#" class="bk-wrting-card">
                                                <div class="bookmark-section1">
                                                    <img class="profile-img" src="/static/images/userprofile/userimage03.jpg" alt="">
                                                    <p class="username">indigo</p>
                                                </div>
                                                <div class="bookmark-section2">
                                                    <p class="card-content-heading">혜성을 닮은 방</p>
                                                    <p class="card-content-text">
                                                        현실 보다 더 중요한 것이 이상이라며 고집하다가 이상만큼 중요한 것이 현실이라고 인정할 수밖에 없는 날. 난 그런 날에 살면서 살아야할 이유를 찾는다. 내 삶과 내 가슴이 남김없이 불타오를 거룩한 사랑 …
                                                    </p>
                                                    <p class="card-info-date">
                                    ...
                                    <div class="md-col-9 sm-col-9 xs-col-4 three-card-align">
                                        <article class="md-col-3 sm-col-3 xs-col-4">
                                            <a href="#" class="bk-author-card">
                                                <div>
                                                    <img class="profile-img-author" src="/static/images/userprofile/userimage02.jpg" alt="">
                                                    <p class="book-mark-author-username">acero</p>
                                        ...
                                        <article class="md-col-3 sm-col-3 xs-col-4">
                                            <a href="#" class="bk-author-card">
                                                <div>
                                                    <img class="profile-img-author" src="/static/images/userprofile/userimage03.jpg" alt="">
                                                    <p class="book-mark-author-username">indigo</p>
                                                    <p class="book-mark-author-caption">내일 일을 오늘 걱정하지 말라 어제의 비로 오늘의 옷을 적시지말라</p>
                                                </div>
                                                <button class="btn-default btn-bookmark-cancle">구독취소</button>
                                            </a>
                                        ...
                                        <article class="md-col-3 sm-col-3 xs-col-4">
                                            <a href="#" class="bk-author-card">
                                                <div>
                                                    <img class="profile-img-author" src="/static/images/userprofile/userimage04.jpg" alt="">
                                                    <p class="book-mark-author-username">flowery</p>
                                                    <p class="book-mark-author-caption">내일 일을 오늘 걱정하지 말라 어제의 비로 오늘의 옷을 적시지말라</p>
                                                </div>
                                                <button class="btn-default btn-bookmark-cancle">구독취소</button>
                                            </a>
                                        ...
                                        <article class="md-col-3 sm-col-3 xs-col-4">
                                            <a href="#" class="bk-author-card">
                                                <div>
                                                    <img class="profile-img-author" src="/static/images/userprofile/userimage05.jpg" alt="">
                                                    <p class="book-mark-author-username">mintlife</p>
                                                    <p class="book-mark-author-caption">내일 일을 오늘 걱정하지 말라 어제의 비로 오늘의 옷을 적시지말라</p>
                                                </div>
                                                <button class="btn-default btn-bookmark-cancle">구독취소</button>
                                            </a>
