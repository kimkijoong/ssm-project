...
<body>
	...
	<main class="main">
		<section class="">
			...
			<form class="post-write-form" action="" method="post">
				<fieldset>
					<input type="hidden" name="post_seq" class="post-seq" value="">
	...
	<script>
		var post_seq = $('.post-seq').val();
		var post_write_form = $('.post-write-form');
		if(post_seq){
			post_write_form.attr("action", "/Home/write");
		} else {
			post_write_form.attr("action", "/Home/update_post");
		}
